...
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { r_addr[1] }]; #IO_L7N_T1_D10_14 Sch=sw[5]
...
set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS18 } [get_ports { w_addr[1] }]; #IO_L24N_T3_34 Sch=sw[8]
